...
//    public void setNeighbor(int[] connsWanted) 
//    {
//    	this.connsWanted = Arrays.copyOf(connsWanted, connsWanted.length);
//    	System.out.println("connsWanted length: "+this.connsWanted.length);
//    	System.out.println("connsWanted[0]: "+this.connsWanted[0]);
//	}
	
	//public void write(ArrayList<SerializableStation> stationArray, ArrayList<SerializableStation[]> connectionArray, int[] connsWanted)  //double latitude, double longitude, int ID
	public void write(int[] connsWanted)  //double latitude, double longitude, int ID
	{
		
//	System.out.println("connectionArray(0)[0] length: "+connectionArray.get(0)[0].stationid);
//	System.out.println("connectionArray(0)[1] length: "+connectionArray.get(0)[1].stationid);
//	System.out.println("stationArray length: "+stationArray.size());
//	System.out.println("connsWanted[0]: "+connsWanted[0]);
